<%-- 
    Document   : RptPredios
    Created on : 11-ago-2024, 13:10:26
    Author     : Usuario
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Reporte Predios | CPRO</title>
...
<body>
    <div class="dashboard-container easyui-layout" fit="true">
        ...
        <div data-options="region:'center'" class="content"  title="REPORTE - RELACIÓN DE PREDIOS" >
                    ...
                    <div data-options="region:'west',split:true, " title="Opciones" style="width:200px;">
                            <div style="margin-left: auto; margin-right: auto; margin-top: 15px; margin-left: 5px;">
                                <div class="bg-primary-subtle text-primary-emphasis fw-bold rounded-top">
                                    <label for="iEstadoPrediosReporte" class="form-label margin-l my-0">Estado</label>
                                </div >
                                <select class="form-select rounded-bottom fs-6 inputOptionsSearchProduct" id="iEstadoPrediosReporte" aria-label="Estado">
                            ...
                            <div style="margin-left: auto; margin-right: auto; margin-top: 15px; margin-left: 5px;">
                                <a href="javascript:void(0)" onclick="GenerarRptPredios()" id="reporteHPredioBtn" class="easyui-linkbutton" data-options="iconCls:'icon-pdf'">Generar Pdf</a>
                            </div>
                        ...
                        <div data-options="region:'center'" title=" ">
                            <div class="container-fluid">
                                <div id="frameWrap">
                                    ...
                                    <iframe id="iFrameReportePredios" style="border: 2px solid #b3b3b3;" name="ReportePredios" width="100%" height="620"></iframe>
                                </div> 
                            </div>
                        </div>
                    </div>

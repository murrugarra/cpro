 ...
 * @author user 1
 */
@WebServlet(name = "EliminarPredio", urlPatterns = {"/EliminarPredio"})
public class EliminarPredio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarPredio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarPredio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try {
                ...
                int predio = Integer.parseInt(request.getParameter("predio").trim());
                ...
                cs = conexion.prepareCall("{CALL sp_Predio_Eliminar(?,?,?,?)}");
                cs.setString(1, iPersonaRegistra);                
                cs.setInt(2, productor);           
                cs.setInt(3, predio);

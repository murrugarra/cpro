 ...
 * @author user 1
 */
@WebServlet(name = "EliminarCampaniaAgricola", urlPatterns = {"/EliminarCampaniaAgricola"})
public class EliminarCampaniaAgricola extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarCampaniaAgricola</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarCampaniaAgricola at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try {
                ...
                cs = conexion.prepareCall("{CALL sp_Campania_Eliminar(?,?,?)}");
                cs.setInt(1, cod);

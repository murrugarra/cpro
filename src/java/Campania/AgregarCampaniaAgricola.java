 ...
 * @author user 1
 */
@WebServlet(name = "AgregarCampaniaAgricola", urlPatterns = {"/AgregarCampaniaAgricola"})
public class AgregarCampaniaAgricola extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AgregarCampaniaAgricola</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AgregarCampaniaAgricola at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try {
                ...
                cs = conexion.prepareCall("{CALL sp_Campania_Insert(?,?,?)}");

 ...
 * @author Usuario
 */
@WebServlet(name = "EditarClase", urlPatterns = {"/EditarClase"})
public class EditarClase extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditarClase</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditarClase at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try {
                ...
                cs = conexion.prepareCall("{CALL sp_Clase_Update(?,?,?,?,?,?)}");
                cs.setInt(1, clase);
                cs.setInt(2, grupoAnt);
                cs.setInt(3, grupoNew);

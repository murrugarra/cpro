 ...
 * @author Usuario
 */
@WebServlet(name = "EliminarUnidadMedida", urlPatterns = {"/EliminarUnidadMedida"})
public class EliminarUnidadMedida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarUnidadMedida</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarUnidadMedida at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try {
                ...
                cs = conexion.prepareCall("{CALL sp_UnidadMedida_Eliminar(?,?,?)}");
                cs.setInt(1, codigo);

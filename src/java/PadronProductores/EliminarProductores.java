 ...
 * @author Usuario
 */
@WebServlet(name = "EliminarProductores", urlPatterns = {"/EliminarProductores"})
public class EliminarProductores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarProductores</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarProductores at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion.getAttribute("usuario") == null){
          response.sendRedirect("CerrarSesion");
            ...
            String respta = "erNo hemos podido eliminar el Productor.";

            // Datos de la solicitud
            int iCodRegReg = Integer.parseInt(request.getParameter("iCodRegReg").trim());
            ...
            try (Connection conexion = newCon.getConnection()) {
                ...
                cs = conexion.prepareCall("{CALL sp_Productor_Eliminar(?,?,?)}");
                cs.setInt(1, iCodRegReg);

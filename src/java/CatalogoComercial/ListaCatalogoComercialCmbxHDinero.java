 ...
 * @author user 1
 */
@WebServlet(name = "ListaCatalogoComercialCmbxHDinero", urlPatterns = {"/ListaCatalogoComercialCmbxHDinero"})
public class ListaCatalogoComercialCmbxHDinero extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListaCatalogoComercialCmbxHDinero</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListaCatalogoComercialCmbxHDinero at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
            String consulta = "SELECT iIdItem, vNombre,iIdUnidadMedida,vAbreviaturaUM, Precio,cPrecio FROM dbo.viewListaElementosCatalogo WHERE iIdItem=1 and iEstado = ? order by vNombre";

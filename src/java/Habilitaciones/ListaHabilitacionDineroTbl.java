 ...
 * @author user 1
 */
@WebServlet(name = "ListaHabilitacionDineroTbl", urlPatterns = {"/ListaHabilitacionDineroTbl"})
public class ListaHabilitacionDineroTbl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListaHabilitacionDineroTbl</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListaHabilitacionDineroTbl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }

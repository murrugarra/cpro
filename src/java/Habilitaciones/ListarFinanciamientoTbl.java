 ...
 * @author Usuario
 */
@WebServlet(name = "ListarFinanciamientoTbl", urlPatterns = {"/ListarFinanciamientoTbl"})
public class ListarFinanciamientoTbl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListarFinanciamientoTbl</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListarFinanciamientoTbl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion.getAttribute("usuario") == null) {
            ...
            try {
                ...
                filtrar = filtrar + " and iIdCampana= "+campania;
                ...
                if (productor != null && !productor.equals("")) {
                    filtrar = filtrar + " and nomb_productor like '%" + productor + "%'";
                }
                ...
                String sql2 = "WITH proyectos AS ( SELECT ROW_NUMBER() OVER( ORDER BY dFechaReg asc ) as Row,"
                        + " * from view_HabilitacionCampania " + filtrar + " )"
                ...
                while (rs2.next()) {
                    ...
                    json = json + "\"porInteres\":\"" + rs2.getString("fPorcentaje_interes") + "\",";
                    json = json + "\"areaInst\":\"" + rs2.getString("fArea_instalada") + "\",";
                    json = json + "\"campania\":\"" + rs2.getString("campania") + "\",";

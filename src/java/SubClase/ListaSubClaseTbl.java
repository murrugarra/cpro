 ...
 * @author Usuario
 */
@WebServlet(name = "ListaSubClaseTbl", urlPatterns = {"/ListaSubClaseTbl"})
public class ListaSubClaseTbl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListaSubClaseTbl</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListaSubClaseTbl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
          ...
          response.sendRedirect("CerrarSesion");
            ...
            try {
                ...
                if (nombre != null && !nombre.equals("")) {
                    filtrar = filtrar + " and vNombreSubClase like '%" + nombre + "%'";
                }
                ...
                int totalRecords = 0;
                String sql1 = "select count(*) as tam from SubClase " + filtrar + "";
                ...
                String sql2 = "WITH proyectos AS ( SELECT ROW_NUMBER() OVER( ORDER BY vNombreGrupo,vNombreClase,vNombreSubClase asc ) as Row,"
                        + " * from view_SubClase " + filtrar + " )"
                ...
                while (rs2.next()) {
                    ...
                    json = json + "\"nombreClase\":\"" + new String(rs2.getString("vNombreClase").getBytes("UTF-8"), "ISO-8859-1") + "\",";
                    json = json + "\"nombre\":\"" + new String(rs2.getString("vNombreSubClase").getBytes("UTF-8"), "ISO-8859-1") + "\",";
                ...
                Logger.getLogger(ListaSubClaseTbl.class.getName()).log(Level.SEVERE, (String) null, var23);
            }
        }
    }

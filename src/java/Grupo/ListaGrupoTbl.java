 ...
 * @author Usuario
 */
@WebServlet(name = "ListaGrupoTbl", urlPatterns = {"/ListaGrupoTbl"})
public class ListaGrupoTbl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListaGrupoTbl</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListaGrupoTbl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
          ...
          response.sendRedirect("CerrarSesion");
            ...
            try {
                ...
                if (nombre != null && !nombre.equals("")) {
                    filtrar = filtrar + " and vNombreGrupo like '%" + nombre + "%'";
                }
                ...
                int totalRecords = 0;
                String sql1 = "select count(*) as tam from Grupo " + filtrar + "";
                ...
                String sql2 = "WITH proyectos AS ( SELECT ROW_NUMBER() OVER( ORDER BY vNombreGrupo asc ) as Row,"
                        + " * from Grupo " + filtrar + " )"
                ...
                while (rs2.next()) {
                    ...
                    json = json + "\"nombre\":\"" + new String(rs2.getString("vNombreGrupo").getBytes("UTF-8"), "ISO-8859-1") + "\",";
                ...
                Logger.getLogger(ListaGrupoTbl.class.getName()).log(Level.SEVERE, (String) null, var23);
            }
        }
    }

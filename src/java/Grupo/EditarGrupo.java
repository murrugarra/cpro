 ...
 * @author Usuario
 */
@WebServlet(name = "EditarGrupo", urlPatterns = {"/EditarGrupo"})
public class EditarGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditarGrupo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditarGrupo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion.getAttribute("usuario") == null){
          response.sendRedirect("CerrarSesion");
            ...
            String respta = "erNo hemos podido actualizar el Registro.";
            ...
            try (Connection conexion = newCon.getConnection()) {
                ...
                cs = conexion.prepareCall("{CALL sp_Grupo_Update(?,?,?,?)}");
                cs.setInt(1, cod);

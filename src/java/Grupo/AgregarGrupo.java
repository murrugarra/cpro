 ...
 * @author Usuario
 */
@WebServlet(name = "AgregarGrupo", urlPatterns = {"/AgregarGrupo"})
public class AgregarGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AgregarGrupo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AgregarGrupo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion.getAttribute("usuario") == null){
          response.sendRedirect("CerrarSesion");
            ...
            String respta = "erNo hemos podido registrar el Registro.";
            ...
            try (Connection conexion = newCon.getConnection()) {
                ...
                cs = conexion.prepareCall("{CALL sp_Grupo_Insert(?,?,?)}");
